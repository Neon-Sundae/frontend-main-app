      ...
      <div className={styles['complete-task-container']}>
        {pending === 'initial' ? (
          <div className={styles['important-content']}>
            <p>Important!</p>
            <p>
              Once you move your task from In-Review to Completed and it cannot
              be changed and the payment to the builder will be made. In next
              step you will make a transaction.
            </p>
            <button
              onClick={() => completeTask(selectedTask?.taskSmartContractId)}
            >
              Next
            </button>
          </div>
