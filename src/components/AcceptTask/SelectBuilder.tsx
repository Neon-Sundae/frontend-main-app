...
const SelectBuilder: FC<ISelectBuilder> = ({ setOpen, handleSuccess, project_budget, selectedBuilder }) => {
    ...
    const { selectedProjectAddress, selectedTask, taskXP } = useSelector((state: RootState) => state.flProject);
    ...
    return (
        <Modal onClose={handleClose}>
            {
                pending === 'add_funds' ? <DepositFundsToWallet /> : (
                        ...
                        </h1>
                        {
                            pending === 'initial' ? (
                                <>
                                    ...
                                    <p>
                                        {
                                            Number(Number(project_budget * 1.1).toFixed(4)) >= selectedTask?.price ? (
